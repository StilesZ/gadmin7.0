...
<body style="padding:20px">
 <table>
        <tr><td colspan=6><input id="order" class="sfdp-input" style="width: 48%;display: inline;" placeholder="排序规则如：id desc" value='{$modue["order"]}'><input id="height" class="sfdp-input"  placeholder="表格行高度设置" value='{$modue["height"]}'  style="width: 48%;display: inline;"></td><td style="text-align:center"><a onclick='save_order()'  class='button' >保存排序</a></td></tr>
        <tr><td colspan=6>
        {$access_html}
